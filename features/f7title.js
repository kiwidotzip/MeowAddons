...
F7Necron
    .register("chat", () => Client.showTitle(`&cNecron damageable`), "[BOSS] Necron: ARGH!")
F7DeadTitles
    .register("servertick", () => {
    ...
    .register("chat", () => Client.showTitle(`&cStorm Dead`, "", 1, 40, 1), "[BOSS] Storm: I should have known that I stood no chance.")